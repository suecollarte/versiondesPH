...
function CamposValidos(){
	...
	if (nombre == "") 	{
		mostrarMensaje("Debe indicar Nombre de Forma de Pago",MSG_STOP);
		return false;
		}
	return true;
	};
		...
		buttons: [
			{
				text: "Eliminar",
				click: function() {
					confirmarMensaje("Forma de Pago será eliminada de la Base de Datos.",EnviaPeticionAjax,ELIMINAR_REG,id);
					$( this ).dialog("close");
					},
