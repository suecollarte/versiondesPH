...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$720000$jgJiLmeAOek8rzZm7FgM4Y$tW8NppqwxqZEHaPf8TR+ml+5Ywy6w0WMO1zuLmsuD7c=','2024-07-01 16:54:23.890264',1,'775251603','Administrador','Sistema','admin@proximahora.cl',1,1,'2024-03-22 00:49:29.465005'),(86,'pbkdf2_sha256$720000$iUgyP9oTEnj8oCEqGYL0il$8nEYKkZqUr5FQ4cAq6x5Ah1mZH/e+5eiv3sd2e52iI4=',NULL,0,'74510876','Armando','Conlledo Espinosa','aconlledo@vilco.cl',0,0,'2024-06-27 07:02:00.084077');
...
INSERT INTO `especialistas_pagos` VALUES (28,'2025-01-01','2025-12-31','2024-06-27','1',90000.00,NULL,NULL,39,1,'especialistas/pagos/74510876/ComprobantePago_2_.pdf','74510876'),(35,'2025-01-01','2025-12-31','2024-07-01','1',90000.00,NULL,NULL,NULL,1,'especialistas/pagos/90938398/20240421-StaCarmela.pdf','90938398');
...
INSERT INTO `usuarios_especialistas` VALUES (39,'',NULL,'0',0.00,0,NULL,'0',NULL,4,NULL,NULL,57);
...
INSERT INTO `usuarios_personas` VALUES (1,'77.525.160-3','1','1','1958-01-09','56 9 9 8280299',320,5109,5,1),(57,'7.451.087-6','1','2','2024-06-05','4234234234',NULL,NULL,NULL,86);
...
CREATE TABLE `usuarios_registros` (
  ...
  `epago_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `usuarios_registros_epago_id_9fcb5fba_fk_especialistas_pagos_id` (`epago_id`),
  CONSTRAINT `usuarios_registros_epago_id_9fcb5fba_fk_especialistas_pagos_id` FOREIGN KEY (`epago_id`) REFERENCES `especialistas_pagos` (`id`)
...
INSERT INTO `usuarios_registros` VALUES (34,'2024-06-27','9.150.521-5','Susana','Collarte','aconlledo@vilco.cl','999999','yVWUAq1dT2rni7TgpSyUQWMEAqN7yzxLt0AzcZpGgyDrWj6oQk6jxkzdUaXqz7IC',0,0,'2024-01-01','0',NULL),(35,'2024-06-29','9.093.839-8','Juan Pablo','Cruz Navarro','aconlledo@vilco.cl','35435345345','QCz6iHTNTy9CP0LyPPocGVFw1swZybB80omvyIDHaFovLvE03fBDyj3HtIjt4Ju3',1,4,'2024-06-02','2',35),(36,'2024-06-29','8.300.166-6','Carmen','Villalobos','aconlledo@vilco.cl','803912381098','aCJaD8xcuw279IFuAA1rmB8LcaQ8VKYt07u8ABqXZILcYQEkn97xLAH475vvpIRd',0,0,'1961-04-16','0',NULL);
...
-- Dump completed on 2024-07-01 22:49:26
