...
gj.datepicker.config = {
    ...
    fontawesome: {
        icons: {
            rightIcon: '<i class="bi bi-calendar-date" aria-hidden="true"></i>',
            previousMonth: '<i class="bi bi-chevron-left" aria-hidden="true"></i>',
            nextMonth: '<i class="bi bi-chevron-right" aria-hidden="true"></i>'
        }
    },
