...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$720000$jgJiLmeAOek8rzZm7FgM4Y$tW8NppqwxqZEHaPf8TR+ml+5Ywy6w0WMO1zuLmsuD7c=',NULL,1,'administrador','','','admin@proximahora.cl',1,1,'2024-03-22 00:49:29.465005');
...
CREATE TABLE `especialistas_agendas` (
  ...
  `estado` smallint(5) unsigned NOT NULL CHECK (`estado` >= 0),
...
CREATE TABLE `especialistas_contratos` (
  ...
  `ctr_pagos` smallint(5) unsigned NOT NULL CHECK (`ctr_pagos` >= 0),
...
INSERT INTO `tablas_regiones` VALUES (1,'Tarapaca','I'),(2,'Antofagasta','II'),(3,'Atacama','III'),(4,'Coquimbo','IV'),(5,'Valparaíso','V'),(6,'OHiggins','VI'),(7,'Maule','VII'),(8,'Bio-Bio','VIII'),(9,'Araucanias','IX'),(10,'Los Lagos','X'),(11,'Aysen','XI'),(12,'Magallanes','XII'),(13,'Metropolitana','XIII'),(14,'Los Rios','XIV'),(15,'Arica','XV'),(16,'Nuble','XVI');
...
CREATE TABLE `usuarios_especialistas` (
  ...
  `estado_suscripcion` smallint(5) unsigned NOT NULL CHECK (`estado_suscripcion` >= 0),
  `promedio_evaluacion` decimal(4,2) NOT NULL,
  `tiempo_consulta` smallint(5) unsigned NOT NULL CHECK (`tiempo_consulta` >= 0),
  `reg_especialista` varchar(120) NOT NULL,
  `ctr_altadctos` smallint(5) unsigned NOT NULL CHECK (`ctr_altadctos` >= 0),
  `categoria_id` bigint(20) NOT NULL,
  `rubro_id` bigint(20) NOT NULL,
  ...
  CONSTRAINT `usuarios_especialist_usuario_id_72bd2a75_fk_usuarios_` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios_personas` (`id`),
...
-- Dump completed on 2024-03-27 21:32:58
